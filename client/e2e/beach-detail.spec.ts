...
test.describe('Beach Detail Page', () => {
  ...
  test.describe('Weather Forecast Feature', () => {
    ...
    test('displays temperature in Celsius with one decimal', async ({ page }) => {
      // TODO: Verify temperature format (e.g., "15.5°C")
    });

    // AC: The system shall display weather conditions with appropriate icons
    test('displays weather conditions with icons', async ({ page }) => {
    ...
    test('shows cached data indicator when API fails', async ({ page }) => {
  ...
  test.describe('Tide Information Feature', () => {
    ...
    test('displays next 3 high and low tides', async ({ page }) => {
    ...
    test('displays tide times in 12-hour Pacific Time format', async ({ page }) => {
    ...
    test('displays tide heights in meters with two decimals', async ({ page }) => {
  ...
  test.describe('Water Quality Feature', () => {
    ...
    test('shows advisory reason when status is Advisory', async ({ page }) => {
    ...
    test('shows off-season message during October-April', async ({ page }) => {
  ...
  test.describe('Webcam Feature', () => {
    ...
    test('embeds live webcam feed when available', async ({ page }) => {
    ...
    test('lazy loads webcam embed', async ({ page }) => {
    ...
    test('shows loading skeleton while webcam loads', async ({ page }) => {
