...
/**
 * Format a number for display (e.g., tide heights)
 */
...
/**
 * Format time for tide display (shorter format)
 */
export function formatTideTime(isoString: string): string {
...
/**
 * Format date for display in tide forecasts
 */
