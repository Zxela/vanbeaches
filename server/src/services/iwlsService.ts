import type { TidePrediction, TideData } from '@van-beaches/shared';
import { cacheManager } from '../cache/cacheManager.js';
import { rateLimiter } from '../cache/rateLimiter.js';

const IWLS_BASE_URL = 'https://api-sine.dfo-mpo.gc.ca/api/v1.1';
...
export async function getTidePredictions(
  ...
  return cacheManager.getOrFetch(cacheKey, async () => {
    ...
    const url = IWLS_BASE_URL + '/stations/' + stationId + '/data?time-series-code=wlp-hilo' +
